                    ...
                    <div class="modal-content border-0 rounded-4 shadow-lg" style="max-height: 100vh;">
                        ...
                        <div class="modal-body p-4">
                            <form method="POST" id="editForm"
                                action="{{ route('admin.vehicles.update', $vehicle->id) }}" class="editForm">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="accordion" id="editVehicleAccordion">
                                    ...
                                    <div class="accordion-item mb-3 rounded-3 overflow-hidden border border-1">
                                        <h2 class="accordion-header" id="editBasicInfoHeading">
                                            <button class="accordion-button fw-bold p-3" type="button"
                                                data-bs-toggle="collapse" data-bs-target="#editBasicInfo"
                                                aria-expanded="true" aria-controls="editBasicInfo">
                                                Vehicle Basic Info
                                            </button>
                                        </h2>
                                        <div id="editBasicInfo" class="accordion-collapse collapse show"
                                            aria-labelledby="editBasicInfoHeading"
                                            ...
                                            <div class="accordion-body">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="owner_type" id="edit_owner_type"
                                                            class="form-select">
                                    ...
                                    <div class="accordion-item rounded-3 overflow-hidden border border-1">
                                        ...
                                        <div id="editDateInfo" class="accordion-collapse collapse"
                                            aria-labelledby="editDateInfoHeading"
                                            data-bs-parent="#editVehicleAccordion">
                                            <div class="accordion-body">
                                                <div class="row g-3">
                                                    <div class="col-md-6">
