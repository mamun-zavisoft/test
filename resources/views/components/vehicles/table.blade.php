                ...
                <td><span class="copyable">
                        ...
                        @else
                            <span class="text-danger"
                                title="This vehicle is not assigned to any hub">{{ $vehicle->license_plate }}</span>
                        @endif
                    </span></td>
                    ...
                    @php
                        ...
                        $documents = [
                            'Registration' => [
                                ...
                                'status' => $docStatuses['registration'],
                            ],
                            'Tax Token' => [
                                'date' => $vehicle->tax_token_validity,
                                'status' => $docStatuses['tax_token'],
                            ],
                            'Fitness' => ['date' => $vehicle->fitness_validity, 'status' => $docStatuses['fitness']],
                            'Road Permit' => [
                                'date' => $vehicle->road_permit_validity,
                                'status' => $docStatuses['road_permit'],
                            ],
                            'Insurance' => [
                                'date' => $vehicle->insurance_validity,
                                'status' => $docStatuses['insurance'],
                            ],
                        ];
                    @endphp
                                ...
                                <div class="doc-status">
                                    ...
                                    @if ($docData['status']['status'] === 'expired')
                                        <span class="status-badge status-expired">
                                            Expired<span
                                                class="days-badge-danger">{{ $docData['status']['days'] }}</span> days
                                            ago
                                        </span>
                                    ...
                                    @elseif($docData['status']['status'] === 'warning')
                                        <span class="status-badge status-warning">
                                            Expires in<span
                                                class="days-badge-warning">{{ $docData['status']['days'] }}</span> days
                                        </span>
                                    @endif
                                </div>
                            @else
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
            <div class="modal-content border-0 rounded-4 shadow-lg" style="max-height: 100vh;">
                ...
                <div class="modal-body p-4">
                    <form method="POST" id="editForm" action="{{ route('admin.vehicles.update', $vehicle->id) }}"
                        class="editForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="accordion-item mb-3 rounded-3 overflow-hidden border border-1">
                                <h2 class="accordion-header" id="editBasicInfoHeading">
                                    <button class="accordion-button fw-bold p-3" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#editBasicInfo" aria-expanded="true"
                                        aria-controls="editBasicInfo">
                                        Vehicle Basic Info
                                    </button>
                                </h2>
                                <div id="editBasicInfo" class="accordion-collapse collapse show"
                                    aria-labelledby="editBasicInfoHeading" data-bs-parent="#editVehicleAccordion">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <select name="owner_type" id="edit_owner_type" class="form-select">
                                                    ...
                                                    <option
                                                        value="1"{{ $vehicle->owner_type == 1 ? 'selected' : '' }}>
                                                        Self</option>
                                                    <option
                                                        value="2"{{ $vehicle->owner_type == 2 ? 'selected' : '' }}>
                                                        External</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Register Number<span
                                                        class="text-danger">*</span></label>
                                                <input type="text" name="license_plate" id="edit_license_plate"
                                                    value="{{ $vehicle->license_plate }}" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Vehicle Type<span
                                                        class="text-danger">*</span></label>
                                                <select name="vehicle_type" id="edit_vehicle_type"
                                                    class="form-select">
                                                    <option value="">Choose</option>
                                                    <option value="1"
                                                        {{ $vehicle->vehicle_type == 1 ? 'selected' : '' }}>
                                                        Covered Van</option>
                                                    <option value="2"
                                                        {{ $vehicle->vehicle_type == 2 ? 'selected' : '' }}>
                                                        Motor Bike</option>
                                                    <option value="3"
                                                        {{ $vehicle->vehicle_type == 3 ? 'selected' : '' }}>
                                                        Pick Up</option>
                                                    <option value="4"
                                                        {{ $vehicle->vehicle_type == 4 ? 'selected' : '' }}>
                                                        Truck</option>
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" name="current_odometer"
                                                    ...
                                                    id="edit_current_odometer" class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="hub_id" id="edit_hub_id" class="form-select">
                                                    ...
                                                    @foreach ($hubs as $hub)
                                                        <option value="{{ $hub->id }}"
                                                            {{ $hub->id == $vehicle->hub_id ? 'selected' : '' }}>
                                                            {{ $hub->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Select Model<span
                                                        class="text-danger">*</span></label>
                                                <select name="vehicle_model_id" id="edit_vehicle_model_id"
                                                    class="form-select">
                                                    <option value="">Choose</option>
                                                    @foreach ($vehicleModels as $model)
                                                        <option value="{{ $model->id }}"
                                                            {{ $model->id == $vehicle->vehicle_model_id ? 'selected' : '' }}>
                                                            {{ $model->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                            ...
                            <div class="accordion-item rounded-3 overflow-hidden border border-1">
                                <h2 class="accordion-header" id="editDateInfoHeading">
                                    <button class="accordion-button collapsed fw-bold p-3" type="button"
                                        data-bs-toggle="collapse" data-bs-target="#editDateInfo"
                                        aria-expanded="false" aria-controls="editDateInfo">
                                        Vehicle Date Information
                                    </button>
                                </h2>
                                <div id="editDateInfo" class="accordion-collapse collapse"
                                    aria-labelledby="editDateInfoHeading" data-bs-parent="#editVehicleAccordion">
                                    <div class="accordion-body">
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" name="registration_date"
                                                    ...
                                                    id="edit_registration_date" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Registration Validity</label>
                                                <input type="date" name="registration_validity"
                                                    value="{{ $vehicle->registration_validity }}"
                                                    id="edit_registration_validity" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Tax Token Validity</label>
                                                <input type="date" name="tax_token_validity"
                                                    value="{{ $vehicle->tax_token_validity }}"
                                                    id="edit_tax_token_validity" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Fitness Validity</label>
                                                <input type="date" name="fitness_validity"
                                                    value="{{ $vehicle->fitness_validity }}"
                                                    id="edit_fitness_validity" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="form-label fw-bold">Road Permit Validity</label>
                                                <input type="date" name="road_permit_validity"
                                                    value="{{ $vehicle->road_permit_validity }}"
                                                    id="edit_road_permit_validity" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" name="insurance_validity"
                                                    ...
                                                    id="edit_insurance_validity" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card h-100">
                                <div class="card-body ms-4">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-8">
                                            <span
                                                class="text-{{ $vehicle->owner_type == 1 ? 'success' : 'warning' }}">
                                                {{ $vehicle->owner_type == 1 ? 'Self' : 'External' }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-8">{{ $vehicle->vehicleModel?->name ?? 'N/A' }}
                                        </div>
                                    </div>
                                    <div class="row mb-2">
